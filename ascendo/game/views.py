...
from ascendo.user_profile.models import Profile
    ...
    def get(self, request):
        if request.user.is_authenticated:
            ...
            if not profile.language:
                context = {'question': Question.objects.all()[0], 'form': AnswerForm()}
...
class CodeView(View):
    def get(self, request):
        if request.user.is_authenticated:
            ...
            if not profile.code:
                context = {'code': Challenge.objects.all()[0], 'form': ResponseForm()}
